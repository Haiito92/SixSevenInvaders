...
Shader "Shader_PlayerProjectile"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float simplePerlin2D83 = snoise( panner90*2.0 );
				simplePerlin2D83 = simplePerlin2D83*0.5 + 0.5;
				float fresnelNdotV72 = dot( NormalWS, ViewDirWS );
				float fresnelNode72 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV72, 5.0 ) );
				float temp_output_76_0 = ( ( ( texCoord82.x - 0.23 ) * simplePerlin2D83 ) + fresnelNode72 );
				float2 texCoord87 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( -0.42,0 );
				

				float3 BaseColor = SampleGradient( gradient67, saturate( ( temp_output_76_0 + ( texCoord87.x - 0.23 ) ) ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNode72 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV72, 5.0 ) );
				float temp_output_76_0 = ( ( ( texCoord82.x - 0.23 ) * simplePerlin2D83 ) + fresnelNode72 );
				float2 texCoord87 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( -0.42,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNode72 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV72, 5.0 ) );
				float temp_output_76_0 = ( ( ( texCoord82.x - 0.23 ) * simplePerlin2D83 ) + fresnelNode72 );
				float2 texCoord87 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( -0.42,0 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - PositionWS );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV72 = dot( NormalWS, ase_viewDirWS );
				float fresnelNode72 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV72, 5.0 ) );
				float temp_output_76_0 = ( ( ( texCoord82.x - 0.23 ) * simplePerlin2D83 ) + fresnelNode72 );
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				surfaceDescription.Alpha = temp_output_76_0;
				#if defined( _ALPHATEST_ON )
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;84;-1904,-208;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;82;-1360,-592;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;-0.12,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;90;-1648,-192;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;0.2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;83;-1392,-208;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;81;-1072,-576;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.23;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;91;16,-32;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=FD65E99FF44F8B6F01D13AEDE10AB3FC063B88A9