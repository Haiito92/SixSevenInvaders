	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = SampleGradient( gradient67, ( temp_output_76_0 + ( texCoord87.x - 0.23 ) ) ).rgb;
